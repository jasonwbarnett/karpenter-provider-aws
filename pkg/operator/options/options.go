...
func (o *Options) AddFlags(fs *coreoptions.FlagSet) {
	...
	fs.Float64Var(&o.ExtraHourlyCostPerHost, "extra-hourly-cost-per-host", env.WithDefaultFloat64("EXTRA_HOURLY_COST_PER_HOST", 0.0), "The additional hourly cost per host, added to the total instance cost, is useful for accounting for extra expenses such as Datadog Infrastructure or APM per-host charges.")
}
